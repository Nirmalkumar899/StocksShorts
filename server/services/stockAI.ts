...
export class StockAIService {
  ...
  private getKnownStockMappings(): { [key: string]: { fullName: string; symbol: string; currentPrice: string; category: string } } {
    return {
      ...
      'nuvama': { fullName: 'Nuvama Wealth Management Ltd', symbol: 'NUVAMA', currentPrice: '₹8,420', category: 'small' },
      'nuvama wealth': { fullName: 'Nuvama Wealth Management Ltd', symbol: 'NUVAMA', currentPrice: '₹8,420', category: 'small' },
      'v2 retail': { fullName: 'V2 Retail Ltd', symbol: 'V2RETAIL', currentPrice: '₹785', category: 'small' },
      'v2retail': { fullName: 'V2 Retail Ltd', symbol: 'V2RETAIL', currentPrice: '₹785', category: 'small' },
      'metro brands': { fullName: 'Metro Brands Ltd', symbol: 'METROBRAND', currentPrice: '₹1,165', category: 'small' },
      'metrobrands': { fullName: 'Metro Brands Ltd', symbol: 'METROBRAND', currentPrice: '₹1,165', category: 'small' },
      'campus activewear': { fullName: 'Campus Activewear Ltd', symbol: 'CAMPUS', currentPrice: '₹385', category: 'small' },
      'campus': { fullName: 'Campus Activewear Ltd', symbol: 'CAMPUS', currentPrice: '₹385', category: 'small' },
