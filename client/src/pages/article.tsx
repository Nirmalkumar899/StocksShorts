  ...
  if (!id) {
    return (
      <div className="min-h-screen bg-background p-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl font-bold text-red-600 mb-4">Article Not Found</h1>
          <p className="text-muted-foreground mb-6">Invalid article link.</p>
          <Link href="/">
            <Button>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Home
    ...
    return (
      <div className="min-h-screen bg-background p-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl font-bold text-red-600 mb-4">Article Not Found</h1>
          <p className="text-muted-foreground mb-6">
            Article ID {id} doesn't exist or failed to load.
          </p>
          <div className="space-x-4">
            <Button onClick={() => refetch()}>
              <RefreshCw className="w-4 h-4 mr-2" />
          ...
          <CardContent>
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="font-medium">Article ID: {article.id}</p>
                  <p>Total Articles: {article.totalArticlesInSheet}</p>
                  <p>Last Updated: {new Date(article.lastUpdated).toLocaleString()}</p>
                </div>
                <div>
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => copyToClipboard(article.shareableLink, "Share link")}
                  >
                    <Copy className="w-4 h-4 mr-2" />
                    Copy Link
                  </Button>
