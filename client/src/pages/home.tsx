...
export default function Home({ initialCategory }: HomeProps = {}) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-neutral-950">
      ...
      {/* WhatsApp Notification Popup - Full Screen */}
      {showWhatsAppNotification && (
        <div className="fixed inset-0 bg-gradient-to-b from-green-600 to-green-800 z-[200] flex flex-col items-center justify-center p-6">
          <button 
            onClick={dismissWhatsAppNotification}
            className="absolute top-4 right-4 text-white/80 hover:text-white text-3xl font-bold bg-white/20 rounded-full w-10 h-10 flex items-center justify-center"
          ...
          <div className="text-center max-w-md">
            ...
            <Button
              ...
              className="w-full bg-white hover:bg-gray-100 text-green-700 font-bold py-4 text-lg rounded-2xl flex items-center justify-center gap-3 shadow-xl"
            ...
            <button 
              onClick={dismissWhatsAppNotification}
              className="mt-6 text-white/70 hover:text-white text-base underline"
