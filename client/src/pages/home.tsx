...
export default function Home({ initialCategory }: HomeProps = {}) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-neutral-950">
      ...
      {/* WhatsApp Notification Banner - Overlay on top of news */}
      {showWhatsAppNotification && (
        <div className="fixed inset-0 bg-black/40 z-[200] flex items-end sm:items-center justify-center p-4" onClick={dismissWhatsAppNotification}>
          <div 
            className="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl p-5 max-w-sm w-full shadow-2xl relative"
          ...
          >
            ...
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-white mb-2">
                Get Stock Queries Answered by HUMAN!
              </h2>
              <p className="text-white/90 text-sm mb-2">
                Not AI — real expert with <strong className="text-yellow-300">10+ years experience</strong> in investing & trading. <strong className="text-yellow-300">FREE!</strong>
              </p>
              <p className="text-white/80 text-xs mb-4">
                Send us a WhatsApp text — happy to help! 💬
              </p>
              <Button
                onClick={openWhatsApp}
                className="w-full bg-white hover:bg-gray-100 text-green-700 font-bold py-3 rounded-xl flex items-center justify-center gap-2 shadow-lg"
