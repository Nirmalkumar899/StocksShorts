...
export default function Home({ initialCategory }: HomeProps = {}) {
  ...
  // Show WhatsApp notification after 2 seconds on first visit
  useEffect(() => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-neutral-950">
      ...
      {showWhatsAppNotification && (
        <div className="fixed inset-0 bg-black/50 z-[200] flex items-center justify-center p-4" onClick={dismissWhatsAppNotification}>
          <div 
            className="bg-white dark:bg-neutral-900 rounded-2xl p-6 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in duration-300"
            onClick={(e) => e.stopPropagation()}
          >
            <button 
              onClick={dismissWhatsAppNotification}
              className="absolute top-3 right-3 text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 text-2xl font-bold"
            ...
            <div className="text-center">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 mb-4 leading-relaxed">
                Now get your stock-specific queries answered <strong>instantly by a Human</strong> — not AI — <strong>free of charge!</strong>
              </p>
              <p className="text-neutral-500 dark:text-neutral-500 text-sm mb-5">
                Yes, a real human! Send us a text on WhatsApp and we're happy to help.
              </p>
              <Button
              ...
              <button 
                onClick={dismissWhatsAppNotification}
                className="mt-3 text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 text-sm"
