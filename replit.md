...
- July 5, 2025: **MAJOR**: Enhanced Connect section with rotating featured SEBI RIA advisors and enhanced search functionality - added auto-rotating featured advisor display that changes every 5 seconds to ensure no preference bias, prominent search bar at top for filtering by name, company, specialization, or location, featured advisor cards show comprehensive details including contact info and experience, visual indicators for "auto-rotating" status, search results display up to 10 advisors with detailed profiles, maintains fairness by constantly rotating featured positions among all registered advisors
