...
- June 28, 2025: **MAJOR**: Enhanced download button with prominent visual highlighting and reliable installation flow - features blue-purple gradient, pulse animation, red notification dot, scale hover effect, and detailed tooltip. Fixed iOS detection to always show notification, corrected iPhone instructions to use Safari's share button (square with arrow) and "Add to Home Screen" option which requires manual navigation to Safari's share menu
