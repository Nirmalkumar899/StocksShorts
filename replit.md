...
- June 29, 2025: **MAJOR**: Implemented comprehensive SEBI compliance disclaimers for AI stock analysis system - replaced OpenAI with Perplexity API for more accurate financial data, added mandatory regulatory warnings stating provider is not SEBI-registered investment advisor, included educational-only disclaimers, removed duplicate warning messages, and ensured all analysis follows SEBI regulations for investor protection
