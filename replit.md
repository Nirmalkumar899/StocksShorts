...
- June 29, 2025: **MAJOR**: Implemented corporate announcements-only AI news system with 20 authentic articles - eliminated analyst reports and breakout stock news per user request, focused exclusively on real corporate announcements from official company sources (board resolutions, tender awards, press releases, acquisition notices), maintained exact 20-article limit with proper priority distribution across major contracts, business expansions, acquisitions, dividend updates, infrastructure projects, and product launches
