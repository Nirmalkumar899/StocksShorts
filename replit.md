...
- July 5, 2025: **MAJOR**: Fixed image system to prioritize company-specific products over candlestick charts - eliminated backend automatic SVG chart generation, enhanced contextual image selection with company business-specific images (ships for GRSE/shipyards, solar panels for renewable companies, construction for infrastructure firms, oil rigs for energy companies), added comprehensive pattern matching for Indian companies and business categories, images now properly reflect what companies actually do/produce instead of generic financial charts
