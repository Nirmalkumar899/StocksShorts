...
- July 1, 2025: **MAJOR**: Fixed article category mapping and improved "View More" functionality - split "Crypto and US Market" into separate categories with distinct icons (Bitcoin for Crypto, DollarSign for US Market), implemented inline "View More" expansion instead of new tab opening, added "View Less" functionality, updated backend mapping to properly handle Google Sheets typo "Crypro" and "US Market" categories, ensured all 12 categories now work correctly with proper article filtering
