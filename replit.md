...
- June 27, 2025: **MAJOR**: Integrated screener.in API for authentic quarterly data, financial metrics, and conference call transcripts - replacing static data with real PE ratios, ROE, debt/equity, sector information, and current market data
