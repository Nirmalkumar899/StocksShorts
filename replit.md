...
- June 28, 2025: **MAJOR**: Enhanced download button with prominent visual highlighting and immediate installation flow - features blue-purple gradient, pulse animation, red notification dot, scale hover effect, and detailed tooltip. Shows instant notification when clicked, then automatically triggers share options. Updated instructions to reflect that share options appear automatically without manual navigation
